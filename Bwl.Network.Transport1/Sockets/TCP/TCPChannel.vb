...
Public Class TCPChannel
                    ...
                    Else
                        If _socket.Available >= length Then
                            ...
                            If receivingPacket.State.TransmitComplete Then
                                ...
                                RaiseEvent PacketReceived(Me, receivingPacket)
                            End If
                        End If
                    End If
                End If
    ...
    Public Sub Open(address As String, options As String) Implements IPacketChannel.Open
        ...
        'TODO: NETCORE If IsNumeric(parts(1)) = False Then Throw New Exception("Address has wrong format! Must be remote_hostname:remote_port or remote_hostname:remote_port:local_port")

        _socket = New Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp)
        SetupSocket(_socket)
        If parts.Length = 3 Then
            'TODO: NETCORE  If IsNumeric(parts(2)) = False Then Throw New Exception("Address has wrong format! Must be remote_hostname:remote_port:local_port")
