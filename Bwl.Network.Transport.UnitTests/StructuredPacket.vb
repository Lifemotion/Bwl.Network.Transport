...
<TestClass()> Public Class StructuredPacketTests
    ...
    Private Function PrepareData(mb As Single) As Byte()
    ...
    Private Sub CompareArrays(Of T As IComparable)(array1 As T(), array2 As T())
    ...
    Private Delegate Sub TestFailSub()

    Private Sub TestException(mustExceptSub As TestFailSub, Optional message As String = "")
        Dim exception = False
        Try
            mustExceptSub()
